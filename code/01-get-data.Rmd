...
##### All the TagSeq files associated with these samples should look like:
...
sratoolkit.2.11.2-ubuntu6/bin/fasterq-dump.2.11.2

Path to download fastq files to in Raven:
