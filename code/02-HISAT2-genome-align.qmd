...
## 1. Accessing genome
For this workflow, we will use the assembled genome of [*Montipora capitata*](https://elifesciences.org/articles/00569) as a reference when quantifying the transcripts of the samples.

Curling the *Montipora capitata* genome assembly. 
```{r, engine= 'bash'}
cd ../data
