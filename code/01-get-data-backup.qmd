---
title: "Step 1: Get Sequence & Genome Data using `curl`and `wget`"
subtitle: "Use `curl` and `wget` to pull sequence data from NCBI and a reference genome from Rutgers University"
author: "Sarah Tanja"
